...
from policy_trainer import MFVanillaSafePolicyTrainer
from policy import VanillaCPQPolicy
...
def train(_config):
    ...
    if _config["safety_lagrange_pid"]:
        ...
        #lagrange = MetaLagrange(**_config["lagrange_params"])
        lagrange_ls=[]
    ...
    policy_trainer = MFVanillaSafePolicyTrainer(
        policy=policy,
        encoder=encoder,
...
if __name__ == "__main__":
    ...
    log_dirs = make_log_dirs(args.task, "vanilla_cpq/"+config_dict["meta_params"]["encoder_type"], config_dict["seed"], config_dict)

        ...
        if self.sample:
            for n in range(self.n_trj):
                if self.train_epoch is None:
                    ...
                    #train_trj_paths += glob.glob(os.path.join(self.data_dir, "goal_idx*", "trj_evalsample%d_step[1-2][0-9][0-9][0-9][0-9][0-9].npy" %(n)))
                else:
                ...
                if self.eval_epoch is None:
                    ...
                    #eval_trj_paths += glob.glob(os.path.join(self.data_dir, "goal_idx*", "trj_evalsample%d_step[1-2][0-9][0-9][0-9][0-9][0-9].npy" %(n)))
                else:

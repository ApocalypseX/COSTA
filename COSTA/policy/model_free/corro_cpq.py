...
class CORROCPQPolicy(SACPolicy):
    def __init__(
        self,
        actor: nn.Module,
        critic1: nn.Module,
        ...
        self.encoder_aggregator=enocder_aggregator.to(device)
    ...
    def learn(self, batch: Dict, context, task, e=0) -> Dict[str, float]:
        ...
        context=self.encoder_aggregator(context)

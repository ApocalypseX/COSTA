...
default_config = dict(
    ...
    env_params=dict(
        ...
        max_episode_steps=300, # built-in max episode length for this environment
    ),
    algo_params=dict(
        ...
        qf_lr=1e-3, # learning rate for q network
        vf_lr=1e-3, # learning rate for v network
        context_lr=1e-3, # learning rate for context encoder

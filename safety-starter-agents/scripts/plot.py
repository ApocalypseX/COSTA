...
def plot_data(data, xaxis='Epoch', value="AverageEpRet", 
 ...
 (0.09019607843137255, 0.7450980392156863, 0.8117647058823529)]
    ...
    if value=="AverageEpCost":
        print(data)
        #sns.tsplot(data=[25]*len(xaxis), time=xaxis, value="TargetCostBound", unit="Unit", condition=condition, ci='sd', dashes=[(2, 2)], **kwargs)
        plt.plot(data['TotalEnvInteracts'], [25]*len(data['TotalEnvInteracts']),linestyle="--", label="TargetCostBound")
    """
...
def main():
    ...
    make_plots(args.logdir, args.legend, args.xaxis, args.value, args.count, 
               ...
               title=args.title, savedir=args.savedir, show=True,
